package base.engineering.motosumiyoshi.sakeapp.chatkit.messages;
...
import base.engineering.motosumiyoshi.sakeapp.chatkit.commons.ViewHolder;
import base.engineering.motosumiyoshi.sakeapp.chatkit.commons.models.IMessage;
import base.engineering.motosumiyoshi.sakeapp.chatkit.commons.models.MessageContentType;
import base.engineering.motosumiyoshi.sakeapp.utility.DateFormatter;
import base.engineering.motosumiyoshi.sakeapp.utility.RoundedImageView;
...
//            isOutcoming = message.getUser().getId().contentEquals(senderId);
            isOutcoming = message.getUser().itsMe();
